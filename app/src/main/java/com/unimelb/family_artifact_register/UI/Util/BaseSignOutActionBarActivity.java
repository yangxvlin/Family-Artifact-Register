 ...
 * title text 3. disable navigation icon by polymorphism to provide sign out logic to child activity
 * Deprecated because we adapt built in action bar design not deleted by open-close principle
 */
@Deprecated
