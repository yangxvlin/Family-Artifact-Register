 ...
 * @description main activity let the user use the app with various bottom navigation contains the
 * logic to transit between different fragments and sign out
 */
