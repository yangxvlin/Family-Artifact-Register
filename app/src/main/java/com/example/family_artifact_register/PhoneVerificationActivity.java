...
public class PhoneVerificationActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mPhoneNumberViews = findViewById(R.id.phone_number_edit_text);
        mSignedInViews = findViewById(R.id.verify_button);
        mVerificationField = findViewById(R.id.verify_edit_text);

        mStartButton = findViewById(R.id.next_button);
        mResendButton = findViewById(R.id.resend_button);
        mSignOutButton = findViewById(R.id.cancel_button);
            ...
            case STATE_VERIFY_SUCCESS:
                ...
                if (cred != null) {
                    if (cred.getSmsCode() != null) {
                        ...
                        mVerificationField.setText("Verified Instantly");
                    }
                }
